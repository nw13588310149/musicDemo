      ...
      return SmartCampusDashboardData(
        ...
        actions: const [
          SmartCampusQuickActionData(
            ...
            foreground: _purple,
            imagePath:
                'assets/images/new/智慧校园/学生端/我的班级.png',
          ),
          SmartCampusQuickActionData(
            label: '我的课表',
            ...
            foreground: _purple,
            imagePath:
                'assets/images/new/智慧校园/学生端/我的课表.png',
          ),
          SmartCampusQuickActionData(
            label: '课堂签到',
            ...
            foreground: _purple,
            imagePath:
                'assets/images/new/智慧校园/学生端/课堂签到.png',
          ),
          SmartCampusQuickActionData(
            label: '我的作业',
            ...
            foreground: _blue,
            imagePath:
                'assets/images/new/智慧校园/学生端/我的作业.png',
          ),
          SmartCampusQuickActionData(
            label: '我的考试',
            ...
            foreground: _orange,
            imagePath:
                'assets/images/new/智慧校园/学生端/我的成绩.png',
          ),
          SmartCampusQuickActionData(
            label: '群聊',
            ...
            foreground: _pink,
            imagePath:
                'assets/images/new/智慧校园/学生端/群聊.png',
          ),
          SmartCampusQuickActionData(
            label: '校圈',
            ...
            foreground: _blue,
            imagePath:
                'assets/images/new/智慧校园/学生端/校圈.png',
          ),
          SmartCampusQuickActionData(
            label: '我的请假',
          ...
          SmartCampusQuickActionData(
            ...
            foreground: _purple,
            imagePath:
                'assets/images/new/智慧校园/学生端/查寝管理.png',
          ),
          SmartCampusQuickActionData(
            label: '校长信箱',
            ...
            foreground: _purple,
            imagePath:
                'assets/images/new/智慧校园/学生端/校长信箱.png',
          ),
        ],
    ...
    case SmartCampusRole.teacher:
      return SmartCampusDashboardData(
        ...
        profile: const SmartCampusProfileData(
          ...
          statusLabel: '授课中',
          organization: '',
          detailLines: ['岗位：任课老师', '权限：授课与课堂管理', '职责：按课表授课，负责签到、批改与课堂反馈'],
        ),
        notices: const [
          SmartCampusNoticeData(
            tag: '教研室',
    ...
    case SmartCampusRole.headTeacher:
      return SmartCampusDashboardData(
        ...
        profile: const SmartCampusProfileData(
          ...
          statusLabel: '运行中',
          organization: '',
          detailLines: ['岗位：班主任', '权限：本班班务管理', '职责：请假查寝、班务协同与家校沟通'],
        ),
        notices: const [
          SmartCampusNoticeData(
            tag: '教研室',
        ...
        primaryPanel: const SmartCampusPanelData(
          ...
          items: [
            SmartCampusPanelItemData(
              ...
              badgeBackground: _purpleSoft,
              title: '学生请假申请待处理',
              subtitle: '进入「请假审批」查看并处理',
              person: '待办',
              personHint: '与顶部「待批请假」统计联动',
              trailing: '待审批',
              avatarSeed: '假',
            ),
            SmartCampusPanelItemData(
        ...
        secondaryPanel: const SmartCampusPanelData(
          ...
          items: [
            SmartCampusPanelItemData(
              ...
              badgeBackground: _pinkSoft,
              title: '家长留言待回复',
              subtitle: '进入「家校沟通」查看对话',
              person: '动态',
              personHint: '与顶部「家校未读」统计联动',
              trailing: '待回复',
              avatarSeed: '家',
            ),
            SmartCampusPanelItemData(
              ...
              badgeBackground: _orangeSoft,
              title: '班级通知已发布',
              subtitle: '可在「班级工作台」查看详情',
              person: '动态',
              personHint: '通知同步至家长与学生端',
              trailing: '已发布',
              avatarSeed: '通',
            ),
          ],
