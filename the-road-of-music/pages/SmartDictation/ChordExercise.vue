<template>
	<view class="tone_content3">
		...
		<view class="box">
			<view class="set_box">
				<!-- 选择区 -->
				<view class="change_box" style="margin: 10px -15px;">
				...
				<view class="time">
					...
					<view class="scroll">
						<view  class="li" v-for="item in minList" @click="onChangeTime1(item)" :class="activeMin == item ? 'active' : ''" v-html="item"></view>
					</view>
				</view>
				<view class="time">
					<view class="title">最高音</view>
					<view class="scroll">
						<view  class="li" v-for="item in maxList"  @click="onChangeTime2(item)" :class="activeMax == item ? 'active' : ''" v-html="item"></view>
					</view>
				</view>
				<view class="time">
...
const minList = ['f','#f','g','#g','a','#a','b','c<sup>1</sup>']
const maxList = [
	'f<sup>2</sup>',
	'#f<sup>2</sup>',
	'g<sup>2</sup>',
